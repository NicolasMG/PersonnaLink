...
public class ModifPersonna  extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private ModifPersonnaViewModel modifPersonnaViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modifPersonnaViewModel = ViewModelProviders.of(this).get(ModifPersonnaViewModel.class);

        datePickerDialog = new DatePickerDialog(this, ModifPersonna.this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemEditText.getText() == null || nameEditText.getText() == null || date == null)
                    Toast.makeText(ModifPersonna.this, "Missing fields", Toast.LENGTH_SHORT).show();
                else {
                    modifPersonnaViewModel.addPersonna(new PersonnaModel(
